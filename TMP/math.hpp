...
template<uint64_t N>
struct __perms_with_rpmt_h
{
    static
    constexpr
    uint64_t
    value = factorial<N>::value * __perms_with_rpmt_h<N - 1>::value;
};

template<>
struct __perms_with_rpmt_h<0>
{
    static
    constexpr
    uint64_t
    value = factorial<0>::value;
};
...
struct  permutations_with_replacement
{
    ...
    value = factorial<N>::value / __perms_with_rpmt_h<K>::value;
};
...
struct accommodation_with_replacement
{
    ...
    constexpr
    uint64_t
    value = N * accommodation_with_replacement<N, K - 1>::value;
};
